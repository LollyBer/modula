...
function editEmp(id){
  ...
  const PERMS=[['cal','📅 Calendario'],['man','🔧 Manutenzioni'],['pellet','🪵 Pellet'],['sites','🏗 Cantieri'],['reports','📸 Rapportini'],['documenti','📁 Documenti'],['macchine','⚙️ Macchine'],['notes','📝 Note'],['todo','✅ Da fare'],['chat','💬 Chat'],['clients','👥 Clienti']];
