...
function renderEmpsManage(){
  ...
  const PI={cal:['📅','Cal.'],man:['🔧','Manut.'],pellet:['🪵','Pellet'],sites:['🏗','Cant.'],reports:['📸','Rapp.'],documenti:['📁','Doc.'],notes:['📝','Note'],chat:['💬','Chat'],clients:['👥','Clienti']};
...
function editEmp(id){
  ...
  const PERMS=[['cal','📅 Calendario'],['man','🔧 Manutenzioni'],['pellet','🪵 Pellet'],['sites','🏗 Cantieri'],['reports','📸 Rapportini'],['documenti','📁 Documenti'],['macchine','⚙️ Macchine'],['notes','📝 Note'],['chat','💬 Chat'],['clients','👥 Clienti']];
