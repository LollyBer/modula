...
function editEmp(id){
  ...
  const PERMS=[['cal','📅 Calendario'],['man','🔧 Manutenzioni'],['pellet','🪵 Pellet'],['sites','🏗 Cantieri'],['reports','📸 Rapportini'],['fatture','🧾 Fatture'],['conti','💰 Conti'],['documenti','📁 Documenti'],['macchine','⚙️ Macchine'],['notes','📝 Note'],['todo','✅ Da fare'],['chat','💬 Chat'],['clients','👥 Clienti']];
