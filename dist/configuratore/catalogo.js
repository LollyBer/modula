...
const SETTORI = [
  { id:'artigiani', ic:'🔧', nome:'Artigiani & Manutenzione',
    desc:'Impiantisti, elettricisti, idraulici, pulizie e assistenza tecnica.',
    proposti:['man','surveys','documenti','fatture','conti'] },

  { id:'edilizia', ic:'🧱', nome:'Edilizia & Ristrutturazioni',
    desc:'Cantieri, lavori su commessa, squadre e avanzamento lavori.',
    proposti:['sites','reports','surveys','documenti','conti'] },

  { id:'professionisti', ic:'📐', nome:'Studi & Servizi Professionali',
    desc:'Studi tecnici, consulenti, agenzie e amministratori.',
    proposti:['todo','documenti','contratti','fatture','conti'] },

  { id:'beauty', ic:'✨', nome:'Beauty, Benessere & Studi',
    desc:'Parrucchieri, estetica, personal trainer e attività su appuntamento.',
    proposti:['prenota','fidelity','conti'] },

  { id:'formazione', ic:'🎓', nome:'Formazione & Corsi',
    desc:'Scuole, corsi professionali, palestre boutique e associazioni.',
    proposti:['prenota','documenti','conti'] },

  { id:'commercio', ic:'🛠️', nome:'Commercio, Riparazioni & Noleggio',
    desc:'Negozi con servizi, laboratori, assistenza e noleggio attrezzature.',
    proposti:['man','catalogo','magazzino','fatture','conti'] },

  { id:'eventi', ic:'🎪', nome:'Eventi & Hospitality',
    desc:'Catering, location, service audio-luci e organizzazione eventi.',
    proposti:['todo','documenti','fatture','conti'] },
